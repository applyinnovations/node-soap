...
export declare class Element {
    ...
    startElement(stack: Element[], nsName: string, attrs: any, options: IWsdlBaseOptions, schemaXmlns: any, name: any): void;
...
export declare class AttributeGroupElement extends ElementElement {
    readonly allowedChildren: {
        [k: string]: typeof Element;
    };
    $minOccurs?: string;
...
export declare class AttributeElement extends ElementElement {
    constructor(nsName: string, attrs: any, options?: IWsdlBaseOptions, schemaAttrs?: any);
}
...
export declare class SchemaElement extends Element {
    ...
    attributeGroup: {
        [name: string]: AttributeGroupElement;
    };
    types: {
