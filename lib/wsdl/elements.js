...
var ElementElement = /** @class */ (function (_super) {
    ...
    ElementElement.prototype.description = function (definitions, xmlns) {
        ...
        if ((this === null || this === void 0 ? void 0 : this.$name) === "FormattedIndYehey") {
...
var ExtensionElement = /** @class */ (function (_super) {
    ...
    ExtensionElement.prototype.description = function (definitions, xmlns) {
        ...
        var returnValue = baseDesc;
        if (!isEmptyObject(attribDesc)) {
            returnValue = __assign(__assign({}, (typeof baseDesc === "object" ? baseDesc : {})), { attributes: __assign(__assign({}, attribDesc), ((baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes) ? baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes : {})) });
        }
        return returnValue;
    };
