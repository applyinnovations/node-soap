...
var ElementElement = /** @class */ (function (_super) {
    ...
    ElementElement.prototype.description = function (definitions, xmlns) {
        ...
        if (isAttributeGroupWithAttributeChildren) {
            ...
            element["attributes"] = __assign(__assign({}, element["attributes"]), attribGroupDesc);
        }
        return element;
    };
    ...
    ExtensionElement.prototype.description = function (definitions, xmlns) {
        ...
        for (var _i = 0, _a = this.children; _i < _a.length; _i++) {
            ...
            if (child instanceof AttributeGroupElement) {
                ...
                // }
                attribDesc = __assign(__assign({}, attribDesc), childDesc === null || childDesc === void 0 ? void 0 : childDesc.attributes);
            }
            if (child instanceof AttributeElement) {
                // @ts-ignore
        ...
        var returnValue = desc;
        if (!isEmptyObject(attribDesc)) {
            returnValue = __assign(__assign({}, (typeof desc === "object" ? desc : {})), { attributes: __assign(__assign({}, attribDesc), ((desc === null || desc === void 0 ? void 0 : desc.attributes) ? desc === null || desc === void 0 ? void 0 : desc.attributes : {})) });
        }
        return returnValue;
    };
...
var ComplexTypeElement = /** @class */ (function (_super) {
    ...
    ComplexTypeElement.prototype.description = function (definitions, xmlns) {
        ...
        for (var _i = 0, children_4 = children; _i < children_4.length; _i++) {
            ...
            if (child instanceof AttributeGroupElement) {
                descAttributes = __assign(__assign({}, descAttributes), desc.attributes);
            }
            if (child instanceof AttributeElement) {
                descAttributes = __assign(__assign({}, descAttributes), desc);
            }
        }
        if (
        // @ts-ignore
