...
exports.ImportElement = exports.IncludeElement = exports.BodyElement = exports.DefinitionsElement = exports.ServiceElement = exports.PortElement = exports.BindingElement = exports.PortTypeElement = exports.OperationElement = exports.TypesElement = exports.SchemaElement = exports.DocumentationElement = exports.MessageElement = exports.AllElement = exports.SequenceElement = exports.AttributeElement = exports.AttributeGroupElement = exports.SimpleContentElement = exports.ComplexContentElement = exports.ComplexTypeElement = exports.EnumerationElement = exports.ChoiceElement = exports.ExtensionElement = exports.RestrictionElement = exports.ListElement = exports.SimpleTypeElement = exports.OutputElement = exports.InputElement = exports.AnyElement = exports.ElementElement = exports.Element = void 0;
var assert_1 = require("assert");
var debugBuilder = require("debug");
var _ = require("lodash");
var utils_1 = require("../utils");
var flattenAttributes = function (attributes) {
    var _a;
    var newAttrib = {};
    for (var key in attributes) {
        if (typeof attributes[key] !== "string") {
            newAttrib = __assign(__assign({}, newAttrib), (_a = {}, _a[key] = typeof attributes[key] !== "string" ? "xs:string" : attributes[key], _a));
        }
    }
    return newAttrib;
};
...
var Element = /** @class */ (function () {
    ...
    Element.prototype.startElement = function (stack, nsName, attrs, options, schemaXmlns, name) {
        currentName = name;
...
var ElementElement = /** @class */ (function (_super) {
    ...
    ElementElement.prototype.description = function (definitions, xmlns) {
        ...
        var isAttributeGroup = this.nsName === "xs:attributeGroup";
        var children = this.children;
        var isAttributeGroupWithAttributeChildren = false;
        if (isAttributeGroup) {
        ...
        if (isAttributeGroupWithAttributeChildren) {
            for (var _b = 0, children_3 = children; _b < children_3.length; _b++) {
                ...
                if (child instanceof AttributeGroupElement ||
                    ...
                    var newDesc = child.description(definitions, xmlns);
                    // @ts-ignore
                    var subAttributes = (newDesc === null || newDesc === void 0 ? void 0 : newDesc.attributes) || {};
                    if (subAttributes) {
                        // @ts-ignore
                        delete newDesc.attributes;
                    }
                    attribGroupDesc = __assign(__assign(__assign({}, attribGroupDesc), newDesc), subAttributes);
                }
            }
        }
        if (isAttributeGroup) {
            delete element[this === null || this === void 0 ? void 0 : this.$name];
        }
        var newValue = __assign(__assign({}, element), attribGroupDesc);
        return newValue;
    };
...
var ListElement = /** @class */ (function (_super) {
    ...
    function ListElement(nsName, attrs, options, schemaAttrs) {
...
var RestrictionElement = /** @class */ (function (_super) {
    ...
    RestrictionElement.prototype.description = function (definitions, xmlns) {
        ...
        if (desc && this.$base) {
            var type_1 = utils_1.splitQName(this.$base);
            var typeName = type_1.name;
            var ns = (xmlns && xmlns[type_1.prefix]) || definitions.xmlns[type_1.prefix];
            var schema_1 = definitions.schemas[ns];
            var typeElement_1 = schema_1 &&
                (schema_1.complexTypes[typeName] ||
                    schema_1.types[typeName] ||
                    schema_1.elements[typeName]);
...
var ExtensionElement = /** @class */ (function (_super) {
    ...
    ExtensionElement.prototype.description = function (definitions, xmlns) {
        ...
        var baseDesc = {};
        var attribDesc = {};
        var myType = this.$base ? utils_1.splitQName(this.$base) : { name: "heeeyy" };
        for (var _i = 0, _a = this.children; _i < _a.length; _i++) {
            var child = _a[_i];
            var childDesc = child.description(definitions, xmlns);
            if (child instanceof SequenceElement || child instanceof ChoiceElement) {
                desc = childDesc;
            }
            if (child instanceof AttributeGroupElement ||
                child instanceof AttributeElement) {
                attribDesc = __assign(__assign({}, attribDesc), childDesc);
            }
        }
        if (this.$base) {
            var type_2 = utils_1.splitQName(this.$base);
            var typeName = type_2.name;
            var ns = (xmlns && xmlns[type_2.prefix]) || definitions.xmlns[type_2.prefix];
            var schema = definitions.schemas[ns];
        ...
        var returnValue = __assign(__assign({}, (typeof baseDesc === "object" ? baseDesc : {})), (typeof desc === "object" ? desc : {}));
        var attributes = flattenAttributes(__assign(__assign({}, attribDesc), ((baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes) ? baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes : {})));
        if (!isEmptyObject(attribDesc)) {
            returnValue = __assign(__assign({}, returnValue), { attributes: attributes });
        }
        return returnValue;
    };
...
var ComplexTypeElement = /** @class */ (function (_super) {
    ...
    ComplexTypeElement.prototype.description = function (definitions, xmlns) {
        ...
        for (var _i = 0, children_4 = children; _i < children_4.length; _i++) {
            ...
            var desc = child.description(definitions, xmlns);
            ...
            if (child instanceof AttributeGroupElement) {
                groupDescAttrib = __assign(__assign({}, groupDescAttrib), desc);
            }
            if (child instanceof AttributeElement) {
                descAttrib = __assign(__assign({}, descAttrib), desc);
            }
        }
        var attributes = flattenAttributes(__assign(__assign({}, descAttrib), groupDescAttrib));
        if (
        // @ts-ignore
...
var AttributeGroupElement = /** @class */ (function (_super) {
    __extends(AttributeGroupElement, _super);
    function AttributeGroupElement() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.allowedChildren = buildAllowedChildren([
            "annotation",
            "complexType",
...
exports.AttributeGroupElement = AttributeGroupElement;
var AttributeElement = /** @class */ (function (_super) {
    __extends(AttributeElement, _super);
    function AttributeElement(nsName, attrs, options, schemaAttrs) {
        return _super.call(this, nsName, attrs, options, schemaAttrs) || this;
    }
    ...
    MessageElement.prototype.postProcess = function (definitions) {
        ...
        if (part.$element) {
            ...
            if (this.element.$type) {
                var type_3 = utils_1.splitQName(this.element.$type);
                var typeNs = (schema.xmlns && schema.xmlns[type_3.prefix]) ||
                    definitions.xmlns[type_3.prefix];
                if (typeNs) {
                    if (type_3.name in Primitives) {
                        // this.element = this.element.$type;
                    }
                    else {
                        // first check local mapping of ns alias to namespace
                        schema = definitions.schemas[typeNs];
                        var ctype = schema.complexTypes[type_3.name] ||
                            schema.types[type_3.name] ||
                            schema.elements[type_3.name];
                        if (ctype) {
            ...
            for (var i = 0; (part = this.children[i]); i++) {
                ...
                var type_4 = nsName.name;
                var schemaDefinition = definitions.schemas[ns];
                if (typeof schemaDefinition !== "undefined") {
                    this.parts[part.$name] =
                        definitions.schemas[ns].types[type_4] ||
                            definitions.schemas[ns].complexTypes[type_4];
                }
                else {
