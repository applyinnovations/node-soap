...
var sanitizeAttribute = function (attributes) {
    var _a;
    var newAttrib = {};
...
var ExtensionElement = /** @class */ (function (_super) {
    ...
    ExtensionElement.prototype.description = function (definitions, xmlns) {
        ...
        var attributes = sanitizeAttribute(__assign(__assign({}, attribDesc), ((baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes) ? baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes : {})));
...
var ComplexTypeElement = /** @class */ (function (_super) {
    ...
    ComplexTypeElement.prototype.description = function (definitions, xmlns) {
        ...
        var attributes = sanitizeAttribute(__assign(__assign({}, descAttrib), groupDescAttrib));
        if (
        // @ts-ignore
