...
var ExtensionElement = /** @class */ (function (_super) {
    ...
    ExtensionElement.prototype.description = function (definitions, xmlns) {
        ...
        if (!isEmptyObject(attribDesc)) {
            var attributes = {};
            for (var key in attribDesc) {
                if (typeof desc[key] !== "string") {
                    attributes = __assign(__assign({}, attributes), (_a = {}, _a[key] = typeof desc[key] !== "string" ? "xs:string" : desc[key], _a));
                }
            }
            // @ts-ignore
            if (baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes) {
                // @ts-ignore
                for (var key in baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes) {
                    if (typeof desc[key] !== "string") {
                        attributes = __assign(__assign({}, attributes), (_b = {}, _b[key] = typeof desc[key] !== "string" ? "xs:string" : desc[key], _b));
                    }
                }
            }
    ...
    ComplexTypeElement.prototype.description = function (definitions, xmlns) {
        ...
        for (var _i = 0, children_4 = children; _i < children_4.length; _i++) {
            ...
            if (child instanceof AttributeGroupElement ||
                ...
                for (var key in desc) {
                    if (typeof desc[key] !== "string") {
                        descAttrib = __assign(__assign({}, descAttrib), (_a = {}, _a[key] = typeof desc[key] !== "string" ? "xs:string" : desc[key], _a));
                    }
                }
            }
        }
        if (!isEmptyObject(descAttrib) && typeof allDesc === "object") {
            // @ts-ignore
            allDesc.attributes = __assign({}, descAttrib);
        }
        return allDesc;
    };
