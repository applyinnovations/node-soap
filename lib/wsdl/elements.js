...
var ExtensionElement = /** @class */ (function (_super) {
    ...
    ExtensionElement.prototype.description = function (definitions, xmlns) {
        ...
        if (!isEmptyObject(attribDesc)) {
            returnValue = __assign(__assign({}, returnValue), { attributes: __assign(__assign({}, attribDesc), ((baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes) ? baseDesc === null || baseDesc === void 0 ? void 0 : baseDesc.attributes : {})) });
        }
        return returnValue;
    };
...
var ComplexTypeElement = /** @class */ (function (_super) {
    ...
    ComplexTypeElement.prototype.description = function (definitions, xmlns) {
        ...
        for (var _i = 0, children_4 = children; _i < children_4.length; _i++) {
            ...
            if (child instanceof AttributeGroupElement) {
                for (var key in desc) {
                    if (typeof desc[key] !== "string") {
                        groupDescAttrib = __assign(__assign({}, groupDescAttrib), (_a = {}, _a[key] = typeof desc[key] !== "string" ? "xs:string" : desc[key], _a));
                    }
                }
            ...
            if (child instanceof AttributeElement) {
                for (var key in desc) {
                    descAttrib = __assign(__assign({}, descAttrib), (_b = {}, _b[key] = typeof desc[key] !== "string" ? "xs:string" : desc[key], _b));
                }
            }
        }
        if (
        ...
        !isEmptyObject(descAttrib) ||
            ...
            // @ts-ignore
            allDesc.attributes = __assign(__assign({}, descAttrib), groupDescAttrib);
        }
        return allDesc;
    };
